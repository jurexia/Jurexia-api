"""
build_administrativo_corpus.py - Iurexia Administrativo Corpus Builder
=======================================================================
Reads LFPA, LOAPF, LGRA, and Ley de Responsabilidad Patrimonial del Estado.
...
NOTE: LAASSP (Adquisiciones), Ley de Obras Públicas, and Ley de Transparencia
were not found in the source directory. They can be added later if available.
"""
...
OUTPUT_DIR = API_DIR / "cache_corpus_administrativo"

# -- Law definitions --
LAWS = [
    {
        "output": "01_ley_procedimiento_administrativo.txt",
        "source": "Ley Federal de Procedimiento Administrativo.txt",
        "type": "full",
    },
    {
        "output": "02_ley_organica_apf.txt",
        "source": "LEY Orgánica de la Administración Pública Federal.txt",
        "type": "full",
    },
    {
        "output": "03_ley_responsabilidades_administrativas.txt",
        "source": "LEY General de Responsabilidades Administrativas.txt",
        "type": "full",
    },
    {
        "output": "04_ley_responsabilidad_patrimonial.txt",
        "source": "LEY Federal de Responsabilidad Patrimonial del Estado.txt",
        "type": "full",
    },
]
...
def main():
    ...
    print("=" * 70)
    print("Iurexia - Administrativo Corpus Builder")
    print("=" * 70)
    ...
    missing = ["LAASSP (Adquisiciones)", "Ley de Obras Públicas", "Ley de Transparencia"]
    print(f"\nNOTE: Not found in source dir: {', '.join(missing)}")
