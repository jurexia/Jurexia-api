"""
build_penal_corpus.py - Iurexia Penal Corpus Builder
=====================================================
Reads CPF, CNPP, Ley Delincuencia Organizada, Ley de Trata, and extracts
Art. 19 CPEUM. Applies cleaning and outputs token-optimized TXT files.

Sources:
  - C:\Proyectos\LEYES_LIMPIAS_TXT\LEYES_FEDERALES\
  - cache_corpus\CPEUM.txt (Art. 19 only)
...
CPEUM_PATH = API_DIR / "cache_corpus" / "CPEUM.txt"
OUTPUT_DIR = API_DIR / "cache_corpus_penal"

# -- Law definitions --
LAWS = [
    {
        "output": "01_codigo_penal_federal.txt",
        "source": "Código Penal Federal.txt",
        "type": "full",
    },
    {
        "output": "02_codigo_nacional_procedimientos_penales.txt",
        "source": "CODIGO NACIONAL DE PROCEDIMIENTOS PENALES.txt",
        "type": "full",
    },
    {
        "output": "03_ley_delincuencia_organizada.txt",
        "source": "Ley Federal contra la Delincuencia Organizada.txt",
        "type": "full",
    },
    {
        "output": "04_ley_trata_personas.txt",
        "source": "General para Prevenir, Sancionar y Erradicar los Delitos en Materia de Trata de Personas",
        "type": "full",
    },
    {
        "output": "05_arts18_23_cpeum.txt",
        "source": "CPEUM",  # special handling
        "type": "cpeum_articles",
        "articles": (18, 23),  # range inclusive
    },
]
...
def extract_cpeum_articles(cpeum_text: str, start_art: int, end_art: int) -> str:
    ...
    header += f"## Artículos {start_art} a {end_art} — Materia Penal\n\n"
...
def main():
    ...
    print("=" * 70)
    print("Iurexia - Penal Corpus Builder")
    print("=" * 70)
    ...
    for law in LAWS:
        ...
        if law["type"] == "cpeum_articles":
            ...
            print(f"\nExtracting: Arts. {start_art}-{end_art} CPEUM")
